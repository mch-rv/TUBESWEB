    ...
    <div class="card my-5">
        ...
        <div class="card-body">
            ...
            <div class="row justify-content-between my-2">
                <div class="col">
                    <a href="<?= base_url('keluar/create'); ?>" class="btn btn-primary"><i class="fa-solid fa-square-plus mr-1"></i>Tambah</a>
                    <a href="<?= base_url('keluar/exportPDF'); ?>" class="btn btn-info"><i class="fa-solid fa-file-arrow-down mr-1"></i>Ekspor Data</a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="<?= base_url('Format/Contoh_Format_Buku_Agenda_Surat_Keluar.xlsx') ?>"><i class="fa-solid fa-download mr-1"></i>Unduh Contoh Excel</a></li>
                    </ul>
                </div>
                <div class="col-4">
                ...
                <?php
                        ...
                        ?>
                            <tr class="text-center">
                                ...
                                <?php if(session()->get('Role')=='Admin'||session()->get('Role')=='Staff'){?>
                                <td>
                                    <a href="<?= base_url('keluar/preview/'.$row->id); ?>" class="btn btn-sm btn-outline-primary mb-1">Preview</a>
                                    <a href="<?= base_url('keluar/edit/'.$row->id); ?>" class="btn btn-sm btn-outline-secondary mb-1">Edit</a>
                                    <a href="<?= base_url('keluar/delete/'.$row->id) ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ?')" class="btn btn-sm btn-outline-danger">Delete</a>
                                </td>
                                <?php }else{ ?>
                                    <td>
                                        <a href="<?= base_url('keluar/preview/'.$row->id); ?>" class="btn btn-sm btn-outline-primary mb-1">Preview</a>
...
<!-- Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?=site_url('keluar/import')?>" method="post" enctype="multipart/form-data">
